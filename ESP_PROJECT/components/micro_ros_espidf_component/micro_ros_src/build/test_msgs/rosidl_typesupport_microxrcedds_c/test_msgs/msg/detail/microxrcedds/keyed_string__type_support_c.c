...
#include "test_msgs/msg/detail/keyed_string__rosidl_typesupport_microxrcedds_c.h"
...
typedef test_msgs__msg__KeyedString _KeyedString__ros_msg_type;

static bool _KeyedString__cdr_serialize(
  ...
  ucdrBuffer * cdr)
{
  ...
  _KeyedString__ros_msg_type * ros_message = (_KeyedString__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static bool _KeyedString__cdr_deserialize(
  ucdrBuffer * cdr,
  void * untyped_ros_message)
{
  (void) cdr;
  ...
  size_t current_alignment)
{
  ...
  const _KeyedString__ros_msg_type * ros_message = (const _KeyedString__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static uint32_t _KeyedString__get_serialized_size(const void * untyped_ros_message)
{
  return (uint32_t)(
    get_serialized_size_test_msgs__msg__KeyedString(
...
static size_t _KeyedString__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_test_msgs__msg__KeyedString(&full_bounded, 0);
}

static message_type_support_callbacks_t __callbacks_KeyedString = {
  "test_msgs::msg",
  "KeyedString",
  _KeyedString__cdr_serialize,
  _KeyedString__cdr_deserialize,
  _KeyedString__get_serialized_size,
  get_serialized_size_test_msgs__msg__KeyedString,
  _KeyedString__max_serialized_size
};

static rosidl_message_type_support_t _KeyedString__type_support = {
  ROSIDL_TYPESUPPORT_MICROXRCEDDS_C__IDENTIFIER_VALUE,
  &__callbacks_KeyedString,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, test_msgs, msg, KeyedString)() {
  return &_KeyedString__type_support;
}
