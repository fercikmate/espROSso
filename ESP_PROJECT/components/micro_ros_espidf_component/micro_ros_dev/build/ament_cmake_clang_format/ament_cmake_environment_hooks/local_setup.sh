...
: ${AMENT_CURRENT_PREFIX:="/home/fercikmate/ftn/osurv/espROSso/esp32try5/components/micro_ros_espidf_component/micro_ros_dev/install/ament_cmake_clang_format"}
